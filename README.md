...
**[▶ Live demo](https://status.superstatus.io)** · [Self-hosting guide](docs/self-hosting.md)

![SuperStatus — the operator console with live status checks and an incident log](docs/images/preview.png)
...
- **Public status page** — a clean dashboard (light/dark) your users can check,
  with per-service history and response-time charts.
