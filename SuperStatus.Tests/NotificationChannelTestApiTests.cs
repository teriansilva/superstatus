...
/// gate (a required secret with nothing typed and nothing stored ⇒ InvalidConfig, no wire call), a
/// typed secret on a brand-new channel actually delivering, and the "blank secret reuses the stored
/// credential" rule so an existing channel can be tested without re-typing it.
/// </summary>
[TestClass]
