...
public class EmailAlertsTests
{
    ...
    public async Task Notifier_NotConfigured_ReturnsSkipped_NoThrow()
    {
        ...
        var check = new StatusCheck { Title = "x", StatusCheckUrl = "u", ServiceLogoUrl = "" };

        var result = await notifier.SendAlertAsync(check, AlertTrigger.Outage, recipientsOverride: "ops@test");
