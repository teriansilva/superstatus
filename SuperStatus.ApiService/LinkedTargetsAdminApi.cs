...
public static class LinkedTargetsAdminApi
{
    ...
    /// <summary>#291: email on + no recipients + no default-recipient fallback can
    ...
    public static string? ValidateAlertProfile(AlertProfileViewModel body)
    {
        ...
        {
            return "Email is enabled but the profile has no recipients; add recipients or enable Email plugin default recipients.";
        }
        return null;
    }
