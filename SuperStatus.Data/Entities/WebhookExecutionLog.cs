...
public class WebhookExecutionLog : EntityBase
{
    ...
    /// <summary>
    /// #291: the linked webhook target this attempt was for. Nullable +
    /// ON DELETE SET NULL so deleting an (unlinked) webhook never destroys
    /// audit history; pre-#291 rows are null. TargetUrl stays denormalized
    /// as the audit-grade record of what was actually hit.
    /// </summary>
