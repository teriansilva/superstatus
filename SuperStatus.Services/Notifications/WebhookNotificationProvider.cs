    ...
    ILogger<WebhookNotificationProvider> logger) : INotificationProvider
{
    ...
    /// <summary>The stable JSON body a folded webhook posts. Additive vs. the old bare
    /// GET — receivers that ignored the (absent) body still get pinged, now via POST.</summary>
