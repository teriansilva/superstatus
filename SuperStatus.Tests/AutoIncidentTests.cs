...
public class AutoIncidentTests
{
    ...
    {
        Id = id, Title = "API", StatusCheckUrl = "https://api/health", WebHookOnErrorUrl = "", ServiceLogoUrl = "",
    ...
    public async Task Draft_RedactsUrlCredentials_FromPublicCopy()
    {
        ...
        {
            Id = 1, Title = "API", WebHookOnErrorUrl = "", ServiceLogoUrl = "", Enabled = true, AutoIncidentEnabled = true,
    ...
    public async Task RunCheckNow_Recovery_ResolvesLinkedAutoIncident()
    {
        ...
        var check = new StatusCheck
        {
            Title = "API", StatusCheckUrl = "https://api.example.com/health", WebHookOnErrorUrl = "", ServiceLogoUrl = "",
            Enabled = true, AutoIncidentEnabled = true, ExpectedStatusCode = 200, ExpectedResponseTimeInMs = 60_000,
