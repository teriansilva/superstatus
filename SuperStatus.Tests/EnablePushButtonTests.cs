...
/// <summary>
/// Issue #241 Phase C2 — the "Enable notifications on this device" control. Probes
...
public class EnablePushButtonTests
{
    ...
    public void Supported_notSubscribed_showsEnable()
    {
        ...
        var cut = ctx.RenderComponent<EnablePushButton>();
        cut.WaitForAssertion(() => Assert.IsTrue(cut.Markup.Contains("Enable notifications on this device")));
    }
    ...
    public void Enable_serverPostFails_rollsBackBrowserSubscription_andStaysDisabled()
    {
        ...
        cut.WaitForAssertion(() =>
        {
            ...
            Assert.IsTrue(cut.Markup.Contains("Enable notifications on this device"));
