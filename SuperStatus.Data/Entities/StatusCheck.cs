...
namespace SuperStatus.Data.Entities
{
    ...
    public class StatusCheck : EntityBase
    {
        ...
        // Minimum minutes between alerts for this check (storm guard), mirroring
        // ThrottleWebHookToExecuteOnlyEveryXMinutes.
        public int AlertThrottleMinutes { get; set; }

        // Email alerts enabled; recipients in EmailRecipients. Config-only in
        // Phase A — delivery lands in Phase B.
        public bool EmailAlertsEnabled { get; set; }

        // Comma/space-separated email recipients for this check.
        public string EmailRecipients { get; set; } = string.Empty;

        // Web-push alerts enabled. Config-only in Phase A — delivery lands in Phase C.
