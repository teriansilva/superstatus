...
public class AdminTabsTests
{
    ...
    [TestMethod]
    public void Console_rendersSixTabs_WebhooksBetweenIncidentsAndAlerts_defaultsToOverview()
    {
        using var ctx = Ctx();
        ...
        CollectionAssert.AreEqual(new[] { "Overview", "Checks", "Incidents", "Webhooks", "Alerts", "Settings" }, labels);
