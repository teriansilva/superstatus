...
/// rollup-aware summary/overview reads. Proves (a) old days are served from the
...
/// correct per check; (c) the per-day overview reads through the same boundary.
/// </summary>
[TestClass]
public class DashboardReadBoundaryTests
{
    ...
    {
        // #138 (PR-C1): the detail-page overview reads through the canonical
