...
namespace SuperStatus.Data.Entities
{
    ...
    public class StatusCheck : EntityBase
    {
        ...
        // Stable per-check pseudo-random integer. Used by the Grid renderer
        // to deterministically pick archetype / decorations / sign text so
        // the same check always renders the same building. Survives Title
        // changes and historical-data cleanup.
        public int Seed { get; set; }

        // First-seen timestamp. Survives the 30-day historical cleanup
        // window so Grid can compute long-term age (Tier 4 requires 90d).
